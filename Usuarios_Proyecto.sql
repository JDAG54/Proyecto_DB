...
GRANT SELECT, INSERT ON cliente TO rol_mesero;
...
-- Permiso Procedimiento de Insertar un Cliente
GRANT EXECUTE ON PROCEDURE sp_insertar_cliente TO 'rol_mesero';
...
-- Funcion de ver el Id de Pedido
GRANT EXECUTE ON FUNCTION fn_buscar_id_pedido_activo TO 'rol_mesero';

-- Funcion de ver el ID de un Item
GRANT EXECUTE ON FUNCTION fn_buscar_id_item TO 'rol_mesero';
